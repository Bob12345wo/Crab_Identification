...
- 20 mm 离线校准验证通过：9/10 帧有效，深度有效率 1.0，平面 RMSE 0.5281 mm，原始中位数 18.5625 mm，校准后 reported 厚度 20.0000 mm。
- 增加参数保护：未启用 `--depth` 时不能单独传入 `--thickness-calibration`，避免校准文件被静默忽略。
